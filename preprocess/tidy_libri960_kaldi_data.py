...
def main(
    ...
    key_label_path = os.path.join(kmeans_data_dir, 'train-960-kmeans.bas.scp')
    ...
    label_dict = read_scp_file(key_label_path, kmeans_data_dir)
    recorder = {}
...
if __name__ == "__main__":
    fbank_data_dir, kmeans_data_dir, out_dir, out_csv = sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4]
    main(fbank_data_dir, kmeans_data_dir, out_dir, out_csv)
